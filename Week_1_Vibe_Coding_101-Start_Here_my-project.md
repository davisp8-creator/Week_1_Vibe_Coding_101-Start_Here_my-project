...
Go to [claude.ai](https://claude.ai) and subscribe to the Max plan ($20/month). This gives you access to Claude Code.
...
If you see `npm: command not found`, install Node.js first from [nodejs.org](https://nodejs.org) (download the LTS version), then try again.
...
1. "Build me a simple Python script that reads a CSV and prints summary statistics."
2. "Create an HTML page with a form that takes a name and shows a personalized greeting."
3. "Write a function that takes a list of numbers and returns the median."
